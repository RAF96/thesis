...
def gui_main_one_dimensional__heat_equation__inhomogeneous(animation_plot, coef, y__x_tzero, external_influences):
    calculate__one_dimensional__heat_equation__cauchy(animation_plot, coef, y__x_tzero, external_influences)
    return animation_plot
...
def calculate__one_dimensional__heat_equation__cauchy(animation_plot, coef, y__x_tzero, external_influences):
